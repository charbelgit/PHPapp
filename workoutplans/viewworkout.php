...
<body style="background-color:white;">
  ...
  <nav class="topnav navbar navbar-inverse" style="border-color: #E86100;">
        <div class="container-fluid">
          ...
          <li><a  href="mealplans.php"><span class="glyphicon glyphicon-cutlery"></span> Meal Plans</a></li>
      ...
      $query= 'SELECT * from post as p INNER JOIN post_workout as pt on p.id=pt.id where pt.id='.$post_id;
      $result=$conn->query($query);
      $row = $result->fetch_assoc();
      /*foreach ($row as $col => $val) {
          echo $col." = ".$val."<br>";
      }*/
      echo '<h1 class="articles">'.$row["title_workout"].'</h1>';
      ...
      echo '<br>';
      echo '<br>';
      echo '<p>'.nl2br($row["workout_text"]).'</p>';
      ?>
