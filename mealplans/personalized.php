                ...
                <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                   ...
                   <div class="mb-4 mb-md-0 mr-5">
                    ...
                    <div class="job-post-item-body d-block d-md-flex">
                      <div class="mr-3">'.$row["experience"].'years'.'</a>'.'  <span class="fl-bigmug-line-portfolio23" align="right" style="background-color:#E86100; opacity:0.85;">' .$row['description'].'</span><div><a title="Send a request" href="mailto:'.$row['email'].'?subject=%20Meal%20Request&body=Hello%20'.$row['username'].',%0AThis%20is%20'.$_SESSION['username'].'%20from%20,%20I%20want%20a%20personalized%20meal%20plan.&cc=info@mail.com">'.$row['email'].'</a></div> <a href="#"> </a></div>
