...
<html ⚡ lang="en" dir="ltr">
  <head>
    ...
    function newwin() {
     myWindow=window.open('viewmeal.php?id=<?php post_meal.id; ?>')
    }
    </script>
    <style media="screen">
  ...
  <body>
    <nav class="topnav navbar navbar-inverse" style="border-color: #E86100; background-color:#E86100;">
          <div class="container-fluid">
            ...
            <li><a  class="active" href="mealplans/mealplans.html"><span class="glyphicon glyphicon-cutlery"></span> Meal Plans</a></li>
...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="../images/meal1.png" style="width:100%">
    <div class="text">Transform your nutrition!</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="../images/meal2.png" style="width:100%">
    <div class="text">Customize your meals</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="../images/meal3.png" style="width:100%">
    <div class="text">Best Experience Ever!</div>
  </div>
...
<div class="search-box-meals">
  ...
  <div class="input-group" align="left">
   <input type="text" class="form-control" placeholder="Search for meal plans...">
...
<div class="personalized-meal" align="right">
  <?php
      if(isset($_SESSION["user_id"]) && isset($_SESSION["profile_type"]) && $_SESSION["profile_type"]==0)
      echo '<button type="button" name="button" class="personalized-button"><i class="fas fa-plus"></i> <a href="create_meal.php" style="text-decoration:none; color:white;">Create a meal plan</a></button> </div>';
      else if (isset($_SESSION["user_id"]) && isset($_SESSION["profile_type"]) && $_SESSION["profile_type"]==1)
       echo '<button type="button" name="button" class="personalized-button" style="height:45px; width:150px;"><a href="personalizedrequest.php" style="color:white;"> Personalized Plan</a></button> </div>';
       else echo '<span> <strong>Login to connect with pros!</strong></span></div>';?>
...
<div class="Mealresults" align="center">
  <h3 class="recentmeals">Recent Meal Plans:</h3>

  <?php
  $query="SELECT * FROM post as p INNER JOIN user_profile as u on p.user_id=u.id INNER JOIN post_meal as pm on p.id=pm.id ORDER BY p.date DESC";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
              if($userid==$row["user_id"])
                $delete_button='<form method="post" ><button title="delete" onclick="delete_meal('.$row["id"].')">Delete Meal Plan</button></form>';
                else
                $delete_button="";
              echo
                  ...
                  <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                     ...
                     <div class="mb-4 mb-md-0 mr-5">
                      ...
                      <div class="job-post-item-body d-block d-md-flex">
                        <div class="mr-3">'.'<a title="Preview" href="viewmeal.php?id='.$row["id"].'"">'.$row["title_meal"].'</a>'.'  <span class="fl-bigmug-line-portfolio23" align="right" style="background-color:#E86100; opacity:0.85;">' .$row['price_meal'].'</span> <a href="#"> </a></div>
                        <div><!--<span class="fl-bigmug-line-big104"></span>--> <span>'.$row["subheader"].'</span></div>
                        '.$delete_button.'<span><a title="View Profile" href=../profile/viewprofile.php?id='.$row['user_id'].'>'.$row["username"]. ' <img style="border-radius:50%;" class="profilepic" src=../profile/'.$row["image_path"].'></a></span>
                      </div>
                     </div>
                  </div>
                </div>
...
function delete_meal(post_id){
  ...
  xmlhttp.open("POST", "deletemeal.php", true);
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
