...
if (isset($_SESSION['business_id'])) {
  $sessionId=$_SESSION['business_id'];
}else {
  $sessionId='';
}
if ($id==$sessionId) {
  header('location:mybusinessprofile.php');
}
  ...
  color: #0062cc;
   ...
   <body>
     <?php if (!isset($_SESSION['business_id'])):
       echo '<a href="../../index.php" style="color:white;"> <button type="button" class="btn" name="button">  Go back to Homepage</button></a>';
       else : echo '<a href="../index.php" style="color:white;"> <button type="button" class="btn" name="button">  Go back to Homepage</button></a>';
       ?>
