...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/css/bootstrap.min.css">
  ...
  <body>
    ...
    if (isset($_POST['submit-business'])) {
      $search_bus = mysqli_real_escape_string($conn, $_POST['search_business']);


    $query="SELECT * FROM business_account WHERE business_name LIKE '%$search_bus%' OR business_website LIKE '%$search_bus%' OR business_address LIKE '%$search_bus%' OR business_country LIKE '%$search_bus%' OR main_services LIKE '%$search_bus%' OR business_username LIKE '%$search_bus%' ORDER BY business_account.business_id DESC";
    ...
    <div class="row intro-child" data-aos="fade" style="opacity: 1;">
                ...
                echo '<div align="center"><h2 class="text-muted">No results for '.$search_bus.'</h2></div>';
              }
            }}
?>
<style media="screen">
