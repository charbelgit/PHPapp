...
<div class="intro" align="center">
  <?php $i=0; ?>
  <div class="fixed-top">
    <form class="" action="search_pro.php" method="post">
...
$query="SELECT * FROM user_profile INNER JOIN user on user_profile.id=user.id WHERE profile_type=0 ORDER BY user.id DESC";
